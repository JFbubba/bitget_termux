...
def summary():
    ...
    return {
        ...
        "voix": voix,
        "caps": {
            "futures_per_trade_usd": cfg("MAX_POSITION_USD", 50.0),
...
def render(s):
    ...
    L.append("CAPS DURS (murs) :")
    L.append(f"  futures : {c['futures_per_trade_usd']}$/trade · {c['portefeuille_notional_usd']}$ notional"
